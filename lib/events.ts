...
const mockEvents = <Event[]>[
  // --- Northridge, CA ---
  {
    ...
    address_details: "18111 Nordhoff St — Oviatt Library Lawn",
    lat: 34.2412,
    lng: -118.5290,
    max_capacity: 500,
  ...
  },
  {
    ...
    address_details: "9301 Tampa Ave — North parking lot",
    lat: 34.2368,
    lng: -118.5353,
    max_capacity: 600,
  ...
  // --- Ventura, CA ---
  {
    ...
    address_details: "1591 Spinnaker Dr — Harbor Cove Beach stage",
    lat: 34.2453,
    lng: -119.2618,
    max_capacity: 1200,
  ...
  },
  {
    ...
    address_details: "Start line at the corner of California St & Harbor Blvd",
    lat: 34.2746,
    lng: -119.2332,
    max_capacity: 1500,
  ...
  // --- Camarillo, CA ---
  {
    ...
    address_details: "740 Ventura Blvd — Center Court",
    lat: 34.2157,
    lng: -119.0432,
    max_capacity: 800,
    image_url: "/mock-event-assets/mockEventImages/food-and-drink.jpg",
  ...
  // --- Oxnard, CA ---
  {
    ...
    address_details: "Start at the park's main entrance on Gonzales Rd",
    lat: 34.1975,
    lng: -119.1820,
    max_capacity: 1000,
    image_url: "/mock-event-assets/mockEventImages/sports.jpg",
  ...
  // --- Thousand Oaks, CA ---
  {
    ...
    address_details: "880 S Westlake Blvd — Grand Ballroom",
    lat: 34.1679,
    lng: -118.8509,
    max_capacity: 400,
    image_url: "/mock-event-assets/mockEventImages/tech.jpg",
  ...
  // --- Los Angeles (Griffith Park) ---
  {
    ...
    address_details: "2800 E Observatory Rd — meet at the main steps",
    lat: 34.1184,
    lng: -118.3004,
    max_capacity: 60,
  ...
  // --- Los Angeles (Downtown) ---
  {
    ...
    address_details: "221 S Grand Ave — Ground floor galleries open late",
    lat: 34.0543,
    lng: -118.2503,
    max_capacity: 700,
  ...
  // --- Los Angeles (Hollywood) ---
  {
    ...
    address_details: "6121 Sunset Blvd — Rooftop Terrace",
    lat: 34.0983,
    lng: -118.3242,
    max_capacity: 200,
    image_url: "/mock-event-assets/mockEventImages/tech.jpg",
  ...
  // --- Los Angeles (Silver Lake) ---
  {
    ...
    address_details: "4800 Hollywood Blvd — Upper terrace lawn",
    lat: 34.1022,
    lng: -118.2975,
    max_capacity: 800,
    image_url: "/mock-event-assets/mockEventImages/art.jpg",
  ...
  // --- Los Angeles (Koreatown) ---
  {
    ...
    address_details: "Meet at the corner of 6th St & Vermont Ave",
    lat: 34.0614,
    lng: -118.2978,
    max_capacity: 60,
    image_url: "/mock-event-assets/mockEventImages/food-and-drink.jpg",
  ...
  // --- Santa Monica, CA ---
  {
    ...
    address_details: "200 Santa Monica Pier — Carousel Park area",
    lat: 34.0100,
    lng: -118.4965,
    max_capacity: 3000,
  ...
  // --- Pasadena, CA ---
  {
    ...
    address_details: "100 N Garfield Ave — Council Chambers & overflow rooms",
    lat: 34.1478,
    lng: -118.1430,
    max_capacity: 250,
    image_url: "/mock-event-assets/mockEventImages/tech.jpg",
  ...
  // --- Long Beach, CA ---
  {
    ...
    address_details: "Turn 11 Fan Zone — entry via Pine Ave gate",
    lat: 33.7637,
    lng: -118.1913,
    max_capacity: 2000,
    image_url: "/mock-event-assets/mockEventImages/sports.jpg",
  ...
  // --- Burbank, CA ---
  {
    ...
    address_details: "3201 W Magnolia Blvd — Main Hall",
    lat: 34.1794,
    lng: -118.3234,
    max_capacity: 400,
    image_url: "/mock-event-assets/mockEventImages/parties.jpg",
  ...
  // --- Glendale, CA ---
  {
    ...
    address_details: "1401 N Verdugo Rd — Outdoor plaza and main hall",
    lat: 34.1763,
    lng: -118.2564,
    max_capacity: 2500,
    image_url: "/mock-event-assets/mockEventImages/food-and-drink.jpg",
  ...
  // --- San Diego (Downtown) ---
  {
    ...
    address_details: "111 W Harbor Dr — Hall C",
    lat: 32.7065,
    lng: -117.1622,
    max_capacity: 2000,
    image_url: "/mock-event-assets/mockEventImages/tech.jpg",
  ...
  // --- San Diego (Balboa Park) ---
  {
    ...
    address_details: "1549 El Prado — Plaza de Panama stage",
    lat: 32.7341,
    lng: -117.1446,
    max_capacity: 5000,
    image_url: "/mock-event-assets/mockEventImages/art.jpg",
  ...
  // --- San Diego (Pacific Beach) ---
  {
    ...
    address_details: "Courts near Grand Ave & Ocean Blvd",
    lat: 32.7990,
    lng: -117.2559,
    max_capacity: 160,
    image_url: "/mock-event-assets/mockEventImages/sports.jpg",
  ...
  // --- Riverside, CA ---
  {
    ...
    address_details: "2601 Fairmount Blvd — Main lawn near the lake",
    lat: 33.9908,
    lng: -117.3672,
    max_capacity: 1500,
    image_url: "/mock-event-assets/mockEventImages/food-and-drink.jpg",
  ...
  },
  {
    ...
    address_details: "3443 Orange St — Main Exhibition Hall",
    lat: 33.9773,
    lng: -117.3741,
    max_capacity: 800,
    image_url: "/mock-event-assets/mockEventImages/tech.jpg",
  ...
  // --- San Jacinto, CA ---
  {
    ...
    address_details: "25905 CA-243 — Trailhead parking area",
    lat: 33.8212,
    lng: -116.9139,
    max_capacity: 300,
    image_url: "/mock-event-assets/mockEventImages/sports.jpg",
  ...
  },
  {
    ...
    address_details: "1700 7th St — Main arena and grounds",
    lat: 33.7852,
    lng: -116.9613,
    max_capacity: 2000,
    image_url: "/mock-event-assets/mockEventImages/music.jpg",
  ...
  // --- Temecula, CA ---
  {
    ...
    address_details: "35960 Rancho California Rd — Estate lawn",
    lat: 33.5108,
    lng: -117.1022,
    max_capacity: 600,
    image_url: "/mock-event-assets/mockEventImages/music.jpg",
  ...
  // --- Escondido, CA ---
  {
    ...
    address_details: "3333 Bear Valley Pkwy — Festival grounds near the amphitheater",
    lat: 33.1411,
    lng: -117.0578,
    max_capacity: 1200,
    image_url: "/mock-event-assets/mockEventImages/food-and-drink.jpg",
  ...
  // --- Palm Springs, CA ---
  {
    ...
    address_details: "277 N Avenida Caballeros — Main lobby",
    lat: 33.8316,
    lng: -116.5452,
    max_capacity: 500,
    image_url: "/mock-event-assets/mockEventImages/art.jpg",
  ...
  // --- Inglewood, CA ---
  {
    ...
    address_details: "700 Warren Ln — Main stage near the rec center",
    lat: 33.9617,
    lng: -118.3617,
    max_capacity: 3000,
    image_url: "/mock-event-assets/mockEventImages/parties.jpg",
  ...
  // --- Santa Barbara, CA ---
  {
    ...
    address_details: "125 N Refugio Rd — Meet at the main entrance",
    lat: 34.5614,
    lng: -120.1214,
    max_capacity: 30,
    image_url: "/mock-event-assets/mockEventImages/outdoor.jpg",
  ...
  // --- Pomona, CA ---
  {
    ...
    address_details: "3801 W Temple Ave — College of Engineering, Bldg 9",
    lat: 34.0574,
    lng: -117.8213,
    max_capacity: 600,
    image_url: "/mock-event-assets/mockEventImages/tech.jpg",
